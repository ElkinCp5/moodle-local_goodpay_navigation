...
/**
 * Strings for component 'local_goodpay_navigation', language 'en'.
 *
...
$string['pluginname'] = 'Goodpay Navigations';
$string['goodpayorder'] = 'Goodpay Orders';
$string['goodpaycoupon'] = 'Goodpay Coupons';
